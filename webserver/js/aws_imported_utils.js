	...
	function get_aws_map() {
	  $.ajax({
	        ...
	        var current_id = 1	       
	          ...
	          $('#key_id_display').attr("disabled", "disabled")
	          $('#key_id_display').attr("placeholder", "")
	          
	          $('#secret_key_display').attr("disabled", "disabled")
	          $('#secret_key_display').attr("placeholder", "")
	          ...
	          html_row += "<td>"
	          html_row += "<input form=\"form_" + current_id + "\" class=\"custom_text_button\" type=\"text\" size=\"15\" value=\"" + vm_map["region"] + "\" name=\"region_display\" readonly>"
	          html_row += "<input form=\"form_" + current_id + "\" type=\"hidden\" value=\"" + vm_map["region"] + "\" name=\"region\">"
	          html_row += "</td>\n"

	          html_row += "<td>"
	          html_row += "<input form=\"form_" + current_id + "\" class=\"custom_text_button\" type=\"text\" size=\"5\" value=\"" + vm_map["AZ"] + "\" name=\"az_display\" readonly>"
            ...
            html_row += "</td>\n"
	          ...
	          html_row += "<td>"
	          html_row += "<input form=\"form_" + current_id + "\" class=\"custom_text_button\" type=\"text\" value=\"" + vm_map["public_dns"] + "\" name=\"public_dns_display\" readonly>"
	          html_row += "<input form=\"form_" + current_id + "\" type=\"hidden\" value=\"" + vm_map["public_dns"] + "\" name=\"public_dns\">"
	          html_row += "</td>\n"	          	         

	          html_row += "<td>"
	          html_row += "<input form=\"form_" + current_id + "\" class=\"custom_text_button\" type=\"text\" value=\"" + vm_map["public_ip_address"] + "\" name=\"public_ip_address_display\" readonly>"
	          html_row += "<input form=\"form_" + current_id + "\" type=\"hidden\" value=\"" + vm_map["public_ip_address"] + "\" name=\"public_ip_address\">"
	          html_row += "</td>\n"
	          
	          html_row += "<td>"
	          html_row += "<input form=\"form_" + current_id + "\" class=\"custom_text_button\" type=\"text\" value=\"" + vm_map["private_ip_address"] + "\" name=\"private_ip_address_display\" readonly>"
	          ...
	          /////////////////////////////////////////////////////////////////////
		        ...
		        //html_row += "<td>"
		        //html_row += "<input form=\"form_" + current_id + "\" type=\"submit\" id=\"button_ssh_" + current_id + "\" class=\"custom_text_button\" name=\"button_ssh\" value=\"TEST\" >"
		        //html_row += "</td>\n"
	          ...
	          $("#button_launch_" +  current_id).click(function() {
	            ...
	            document.getElementById(form_id).action = "/configure/launch_aws_instance/";
	            document.getElementById(form_id).submit();
	          });   
	          
	          $("#button_delete_" +  current_id).click(function() {
	            var form_id = $(this).attr("form");
	            document.getElementById(form_id).action = "/aws_imported/";
	          ...
	          $("#button_shutdown_" +  current_id).click(function() {
	            var form_id = $(this).attr("form");
	            document.getElementById(form_id).action = "/aws/terminate_aws_instance/";
